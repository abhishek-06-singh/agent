...
import MobileCardsReports from './MobileCardsReports'
...
export default function DealsTable() {
  ...
  return (
    <div className="mt-8">
      ...
      <div className="hidden md:block overflow-x-auto rounded-xl border border-bordercolor bg-cardbg shadow-md">
  <DesktopReportsTable
